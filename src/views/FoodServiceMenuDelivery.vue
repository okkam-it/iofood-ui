  ...
  >
    ...
    <template v-else-if="foodService">
      ...
      <div class="sticky-header" v-if="showStickyHeader && selectedMenu">
        ...
        <div class="menu-sections" id="menu-sections-buttons-box">
        ...
        <div>
          <div class="footer-cart">
            ...
            <template v-else>
              ...
              <div>
                <span class="btn-cart" @click="showCartDelivery()"
                  >Completa ordine</span
                >
              </div>
            </template>
          </div>
...
.menu-selector-modal .menu-item.active {
  /* background-color: #f66969; */
}
